...
##        validaciones2.loc[26,'Cetegoría']='Layout'
    ...
    if len(mejoras): #si hay entindades en el layer mejoras comienza la validacion de las mismas sino arroja error que no hay nada en ese layer
        ...
        if "-1" in band_poly_mej or "-2" in band_poly_mej: # si hay un -1 en la bandera arroja error 
            ...
            validaciones2.loc[16,'Observacion']="Error: Existen entidades distintas de Polylineas o bloque form / form_empadronado en alguno de los layers de Mejoras"
            ...
            validaciones2.loc[17,'Observacion']="Error: Existen entidades distintas de Polylineas o bloque form / form_empadronado en alguno de los layers de Mejoras"
            ...
            validaciones2.loc[18,'Observacion']="Error: Existen entidades distintas de Polylineas o bloque form / form_empadronado en alguno de los layers de Mejoras"
            ...
            validaciones2.loc[19,'Observacion']="Error: Existen entidades distintas de Polylineas o bloque form / form_empadronado en alguno de los layers de Mejoras"
            ...
            if '-1' in band_poly_cer_mej:
                    ...
                    validaciones2.loc[16,'Observacion']="Error: Se dibujaron polylineas Abiertas en alguno de los layers de Mejoras, deben ser Cerradas"
                    validaciones2.loc[16,'Cetegoría']='Mejoras'
            else:
                    validaciones2.loc[16,'Resultado']=0 # si hay un -1 en la bandera arroja error 
                    validaciones2.loc[16,'Observacion']="OK: Se dibujaron polylineas Cerradas en los layers de Mejoras"
                    validaciones2.loc[16,'Cetegoría']='Mejoras'
            ...
            if '0' in band_poly_color_mej:
                ...
                validaciones2.loc[17,'Observacion']="OK: Se dibujaron polylineas Cerradas configuradas correctamente en el layer MEJORAS"
                validaciones2.loc[17,'Cetegoría']='Mejoras'
                ...
                validaciones2.loc[17,'Observacion']="Error: Color de polylineas erroneo en layer de mejoras"
                validaciones2.loc[17,'Cetegoría']='Mejoras'
        ...
        validaciones2.loc[16,'Observacion']="OK: Validacion de Mejoras no corresponde por encontrase el layer vacío, verifique que se trate de un inmueble baldío"
        validaciones2.loc[16,'Cetegoría']='Mejoras'

        validaciones2.loc[17,'Resultado']=99 # si no hay un -1 en la bandera indica que la validación es correcta.
        validaciones2.loc[17,'Observacion']="OK: Validacion de Mejoras no corresponde por encontrase el layer vacío, verifique que se trate de un inmueble baldío"
        validaciones2.loc[17,'Cetegoría']='Mejoras'

        validaciones2.loc[18,'Resultado']=99 # si no hay un -1 en la bandera indica que la validación es correcta.
        validaciones2.loc[18,'Observacion']="OK: Validacion de Mejoras no corresponde por encontrase el layer vacío, verifique que se trate de un inmueble baldío"
        validaciones2.loc[18,'Cetegoría']='Mejoras'

        validaciones2.loc[19,'Resultado']=99 # si no hay un -1 en la bandera indica que la validación es correcta.
        validaciones2.loc[19,'Observacion']="OK: Validacion de Mejoras no corresponde por encontrase el layer vacío, verifique que se trate de un inmueble baldío"
        validaciones2.loc[19,'Cetegoría']='Mejoras'
